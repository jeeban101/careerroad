        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <Route className="text-purple-400 text-2xl mr-2 dark:glow-pulse" />
              <span className="font-bold text-xl text-foreground">CareerRoad</span>
            </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map(social => (
                <a
                  key={social.label}
                  href={social.href}
                  className="text-muted-foreground hover:text-purple-400 transition-colors p-2 rounded-lg hover:bg-secondary/50"
