    ...
    <section className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="floating absolute top-10 left-1/4 opacity-20">
          <Sparkles className="h-6 w-6 text-purple-400 dark:glow-pulse" />
        </div>
        <div className="floating absolute bottom-20 right-1/4 opacity-20" style={{ animationDelay: '3s' }}>
          <Map className="h-5 w-5 text-blue-400 dark:glow-pulse" />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full mb-6 backdrop-blur-glass border border-purple-500/30">
            ...
            <span className="text-sm font-medium text-purple-500 dark:text-purple-200">Powered by Advanced AI</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`text-center p-4 sm:p-6 lg:p-8 rounded-2xl bg-gradient-to-br ${feature.gradientBg} border ${feature.borderColor} backdrop-blur-glass card-hover dark:shimmer`}
              style={{ animationDelay: `${index * 0.2}s` }}
            >
              <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${feature.iconBg} rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 dark:pulse-glow`}>
                <feature.icon className="text-white" size={24} />
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">{feature.title}</h3>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 text-center">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-4xl mx-auto">
            <div className="backdrop-blur-glass rounded-xl p-4 sm:p-6 border border-purple-500/20 bg-card/10">
              <div className="text-2xl sm:text-3xl font-bold text-foreground mb-2">10K+</div>
              <div className="text-sm sm:text-base text-purple-400">Career Paths Generated</div>
            </div>
            <div className="backdrop-blur-glass rounded-xl p-4 sm:p-6 border border-blue-500/20 bg-card/10">
              <div className="text-2xl sm:text-3xl font-bold text-foreground mb-2">95%</div>
              <div className="text-sm sm:text-base text-blue-400">Success Rate</div>
            </div>
            <div className="backdrop-blur-glass rounded-xl p-4 sm:p-6 border border-emerald-500/20 bg-card/10">
              <div className="text-2xl sm:text-3xl font-bold text-foreground mb-2">50+</div>
              <div className="text-sm sm:text-base text-emerald-400">Career Fields</div>
            </div>
          </div>
        </div>
      </div>
