      ...
      <div className="container max-w-7xl mx-auto p-6">
        ...
        >
          ...
          <motion.div variants={cardVariants}>
            <Card className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 border-purple-500/30 hover:border-purple-400/50 transition-all duration-300">
              ...
              <CardContent>
                ...
                <Progress value={levelProgress} className="h-2 bg-purple-900/50" />
              </CardContent>
            </Card>
          </motion.div>
          ...
          {/* Streak Card */}
          <motion.div variants={cardVariants}>
            <Card className="bg-gradient-to-br from-orange-600/20 to-red-800/20 border-orange-500/30 hover:border-orange-400/50 transition-all duration-300">
              <CardHeader className="pb-3">
                <CardTitle className="text-white flex items-center gap-2 text-lg">
          ...
          {/* Roadmaps Card */}
          <motion.div variants={cardVariants}>
            <Card className="bg-gradient-to-br from-blue-600/20 to-cyan-800/20 border-blue-500/30 hover:border-blue-400/50 transition-all duration-300">
              <CardHeader className="pb-3">
                <CardTitle className="text-white flex items-center gap-2 text-lg">
          ...
          <motion.div variants={cardVariants}>
            <Card className="bg-gradient-to-br from-emerald-600/20 to-green-800/20 border-emerald-500/30 hover:border-emerald-400/50 transition-all duration-300">
              <CardHeader className="pb-3">
                <CardTitle className="text-white flex items-center gap-2 text-lg">
