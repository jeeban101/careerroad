    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="floating absolute top-20 left-1/4 opacity-20">
          <Quote className="h-8 w-8 text-purple-400 dark:glow-pulse" />
        </div>
        <div className="floating absolute bottom-20 right-1/4 opacity-20" style={{ animationDelay: '4s' }}>
          <Star className="h-6 w-6 text-yellow-400 dark:glow-pulse" />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className={`p-8 rounded-2xl bg-gradient-to-br ${testimonial.gradientBg} border ${testimonial.borderColor} backdrop-blur-glass card-hover dark:shimmer`}
            ...
            >
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full flex items-center justify-center mr-4 dark:glow-pulse">
        ...
        <div className="text-center mt-16">
          <div className="backdrop-blur-glass rounded-2xl p-8 border border-purple-500/20 max-w-2xl mx-auto bg-card/30">
            ...
            <button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 dark:shimmer">
