      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className={`text-center p-8 rounded-2xl bg-gradient-to-br ${feature.gradientBg} border ${feature.borderColor} backdrop-blur-glass card-hover shimmer`}
              style={{ animationDelay: `${index * 0.2}s` }}
            >
              <div className={`w-16 h-16 bg-gradient-to-br ${feature.iconBg} rounded-full flex items-center justify-center mx-auto mb-6 pulse-glow`}>
        ...
        <div className="mt-20 text-center">
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="backdrop-blur-glass rounded-xl p-6 border border-purple-500/20">
              <div className="text-3xl font-bold text-white mb-2">10K+</div>
              <div className="text-purple-300">Career Paths Generated</div>
            </div>
            <div className="backdrop-blur-glass rounded-xl p-6 border border-blue-500/20">
              <div className="text-3xl font-bold text-white mb-2">95%</div>
              <div className="text-blue-300">Success Rate</div>
            </div>
            <div className="backdrop-blur-glass rounded-xl p-6 border border-emerald-500/20">
              <div className="text-3xl font-bold text-white mb-2">50+</div>
              <div className="text-emerald-300">Career Fields</div>
            </div>
          </div>
        </div>
      </div>
